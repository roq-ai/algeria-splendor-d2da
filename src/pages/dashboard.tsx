...
import { getFlights } from 'apiSdk/flights';
...
import { OfferListPage as ShowCaseList } from 'pages/offers';
...
function DashboardPage() {
  ...
  const flightStat = useSWR<PaginatedInterface<FlightInterface>>(
    () => `/flights`,
    () => getFlights({ limit: 1, offset: 0 }),
  );
  ...
  const statResults: { title: string; result: number; isLoading: boolean }[] = [
    ...
    {
      title: 'Flights',
      result: flightStat?.data?.totalCount,
          ...
          <Stack direction="column" spacing={8} flex={{ base: 1, md: 7 }}>
            ...
            <Box>
              <Flex mb={4} justifyContent={'space-between'}>
                ...
                <NextLink href={`offers`} passHref legacyBehavior>
                  <Button
